...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_dedac7001666460f, []int{0}
}
...
func (m *Params) GetSecondsPerDay() uint64 {
	if m != nil {
		return m.SecondsPerDay
	}
	return 0
}
...
func init() {
	proto.RegisterFile("blockmazechain/validatorbonus/params.proto", fileDescriptor_dedac7001666460f)
}
...
var fileDescriptor_dedac7001666460f = []byte{
	...
	0x99, 0xfa, 0x20, 0x16, 0x44, 0x54, 0xe9, 0x3c, 0x23, 0x17, 0x5b, 0x00, 0xd8, 0x60, 0x21, 0x2d,
	...
	0x06, 0x0b, 0x09, 0xa9, 0x71, 0xf1, 0x17, 0xa7, 0x26, 0xe7, 0xe7, 0xa5, 0x14, 0xc7, 0x17, 0xa4,
	0x16, 0x81, 0xcc, 0x91, 0x60, 0x01, 0xab, 0xe2, 0x85, 0x0a, 0x07, 0xa4, 0x16, 0xb9, 0x24, 0x56,
	0x5a, 0xe9, 0xbf, 0x58, 0x20, 0xcf, 0xd8, 0xf5, 0x7c, 0x83, 0x96, 0x1a, 0x5a, 0xe8, 0x54, 0xa0,
	0x87, 0x0f, 0xc4, 0x1b, 0x4e, 0xf6, 0x27, 0x1e, 0xc9, 0x31, 0x5e, 0x78, 0x24, 0xc7, 0xf8, 0xe0,
	0x91, 0x1c, 0xe3, 0x84, 0xc7, 0x72, 0x0c, 0x17, 0x1e, 0xcb, 0x31, 0xdc, 0x78, 0x2c, 0xc7, 0x10,
	0xa5, 0x4a, 0xc8, 0x84, 0x92, 0xca, 0x82, 0xd4, 0xe2, 0x24, 0x36, 0x70, 0xc8, 0x18, 0x03, 0x02,
	0x00, 0x00, 0xff, 0xff, 0x72, 0x41, 0x10, 0x36, 0x8f, 0x01, 0x00, 0x00,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if this.SecondsPerDay != that1.SecondsPerDay {
		return false
	}
	return true
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.SecondsPerDay != 0 {
		i = encodeVarintParams(dAtA, i, uint64(m.SecondsPerDay))
		i--
		dAtA[i] = 0x20
	}
	if m.TotalCycles != 0 {
...
func (m *Params) Size() (n int) {
	...
	if m.SecondsPerDay != 0 {
		n += 1 + sovParams(uint64(m.SecondsPerDay))
	}
	return n
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SecondsPerDay", wireType)
			}
			m.SecondsPerDay = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SecondsPerDay |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
